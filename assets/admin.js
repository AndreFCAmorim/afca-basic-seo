(function ($) {
	...
	$(document).on('click', '.afca-upload-image', function (e) {
		...
		var frame = wp.media({
			title: (window.AFCA_SEO_I18N && AFCA_SEO_I18N.pickTitle) || 'Escolher imagem',
			button: { text: (window.AFCA_SEO_I18N && AFCA_SEO_I18N.pickButton) || 'Usar esta imagem' },
			multiple: false
		});
	...
	function updateCount($el) {
		...
		var label = (window.AFCA_SEO_I18N && AFCA_SEO_I18N.chars) || 'caracteres';
	...
	$(function () {
		$('.afca-count').each(function () { updateCount($(this)); });
	});
